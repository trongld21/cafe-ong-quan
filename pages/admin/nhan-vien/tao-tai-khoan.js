  ...
  return (
    <div className="flex justify-center items-center h-screen">
      <div className="bg-white p-8 rounded shadow-md w-96">
        <h2 className="text-xl font-semibold mb-4">Tạo tài khoản nhân viên mới</h2>
        <div className="mb-4">
        <Link href="/admin/nhan-vien" className="p-2 bg-blue-400 rounded-md text-white">Quay lại trang quản lý nhân viên</Link>
        </div>
        {successMessage && (
